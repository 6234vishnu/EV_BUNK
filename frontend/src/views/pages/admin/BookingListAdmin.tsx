...
const BookingListAdmin: React.FC = () => {
  ...
  const getStatusBadgeClass = (status: BookingStatus) => {
    switch (status) {
      case "Booked":
        return "bookingListAdmin-status-badge bookingListAdmin-status-booked";
      case "Completed":
        return "bookingListAdmin-status-badge bookingListAdmin-status-completed";
      case "Cancelled":
        return "bookingListAdmin-status-badge bookingListAdmin-status-cancelled";
      default:
        return "bookingListAdmin-status-badge";
    }
  };
