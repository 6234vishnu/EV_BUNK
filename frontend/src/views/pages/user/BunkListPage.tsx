      ...
      <div className="content-container">
              ...
              {paginatedBunks.map((bunk) => (
                <div key={bunk._id} className="bunk-card">
                  ...
                  <div className="bunk-details">
                    <h2>{bunk.name}</h2>
                    <p style={{color:"black"}} className="bunk-location">{bunk.address}, {bunk.city}</p>
                    <p style={{color:"black"}} className="bunk-capacity">
                      Capacity: {bunk.totalPorts - bunk.availablePorts} / {bunk.totalPorts} ports available
                    </p>
                    ...
                    <div className="bunk-status">
                      <span className={`status-indicator ${bunk.allowBooking ? 'available' : 'unavailable'}`}></span>
                      <span>{bunk.allowBooking ? 'Available' : 'Unavailable'}</span>
                    </div>
                    <button
                      className={`bunk-action-button ${!bunk.allowBooking ? 'disabled' : ''}`}
        ...
        <aside className="side-animation">
          ...
          <div className="info-box">
            <h3>Need Help?</h3>
            <p style={{color:"black"}}>Contact our support team for assistance with booking.</p>
